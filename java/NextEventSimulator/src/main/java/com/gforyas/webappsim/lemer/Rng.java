...
public class Rng {
  ...
  protected long MODULUS      = 2147483647; /* DON'T CHANGE THIS VALUE                   */
  protected  long MULTIPLIER   = 48271;      /* use 16807 for the "minimal standard"      */
  protected static long CHECK = 399268537L; /* use 1043616065 for the "minimal standard" */
  protected long DEFAULT      = 123456789L; /* initial seed, use 0 < DEFAULT < MODULUS   */

  protected long seed         = DEFAULT;    /* seed is the state of the generator        */

  public Rng () {
    putSeed(DEFAULT);                     /* set initial state to DEFAULT */
  }

  public Rng(boolean child){
    // this should not do anything
  }

  public Rng (long seed) {
    putSeed(seed);                           /* set initial state to seed       */
  }
